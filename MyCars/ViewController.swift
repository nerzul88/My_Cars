...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var segmentedControl: UISegmentedControl! {
        didSet {
            ...
            //создаём аттрибуты для белого и чёрного текстов
            ...
            //текст сегмента - белый, а выделенного сегмента - чёрный
    ...
    //метод для распределения данных по интерфейсу
    ...
    private func getDataFromFile() {
        ...
        //проверяем количество записей в переменной records
